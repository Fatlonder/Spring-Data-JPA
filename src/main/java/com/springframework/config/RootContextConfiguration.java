        ...
        AsyncConfigurer, SchedulingConfigurer
{
    ...
    public Jaxb2Marshaller jaxb2Marshaller()
    {
        ...
        marshaller.setPackagesToScan(new String[] { "com.springframework" });
        return marshaller;
    }
    ...
    public DataSource customerSupportDataSource()
    {
        ...
        return lookup.getDataSource("jdbc/personDataSource");
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean()
    {
        ...
        factory.setPackagesToScan("com.springframework.dto");
